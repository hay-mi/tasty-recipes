  ...
  return (
    <div className="py-20 px-2 max-w-4xl mx-auto">
      ...
      {meals ? (
        <div className="grid gap-16">
          {meals.map((meal) => (
            <article key={meal.idMeal}>
              ...
              <ul className="flex items-center justify-start gap-5 flex-wrap mt-8">
                {meal.strYoutube && (
                  <li>
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="bg-[#FEA609] font-normal text-base rounded-full py-2 px-6 hover:bg-neutral-400 transition-all duration-150 hover:text-neutral-900"
                    >
                      Video
                    </a>
                  </li>
        ...
        <h2 className="text-3xl text-center text-neutral-900  font-bold mt-12">
